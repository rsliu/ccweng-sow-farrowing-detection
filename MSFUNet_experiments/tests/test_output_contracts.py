...
EXPECTED_SNIPPETS = {
    "MSFUNet_experiments/code/trainers/msfunet_ablation/lopo_msfunet_ablation_trainer.py": [
        '["pig","acc","prec","rec","f1","spec","auc","macro_acc"]',
        '"summary.csv"',
    ],
    "MSFUNet_experiments/code/trainers/ex2_backbone_comparison/lopo_squeezenet_baseline_trainer.py": [
        '["pig","thr","acc","precision","recall","f1","specificity","auc","params","latency_ms","fps"]',
        '"lopo_test_metrics.csv"',
    ],
    "MSFUNet_experiments/code/trainers/ex2_backbone_comparison/lopo_resnet18_trainer.py": [
        '["pig","acc","prec","rec","f1","spec","auc","thr","params","lat_ms","fps"]',
        '"lopo_summary.csv"',
    ],
    "MSFUNet_experiments/code/trainers/ex2_backbone_comparison/lopo_vit_tiny_trainer.py": [
        '["pig","thr","acc","precision","recall","f1","specificity","auc","params","latency_ms","fps"]',
        '"lopo_summary.csv"',
    ],
    "MSFUNet_experiments/code/trainers/ex2_backbone_comparison/lopo_vit_base_trainer.py": [
        '["pig","acc","prec","rec","f1","spec","auc","thr","params","lat_ms","fps"]',
        '"lopo_summary.csv"',
    ],
    "MSFUNet_experiments/code/trainers/ex2_backbone_comparison/lopo_msanet_trainer.py": [
        '["pig", "acc", "precision", "recall", "f1", "specificity", "auc", "thr", "params", "latency_ms", "fps"]',
        '"lopo_summary.csv"',
    ],
    "MSFUNet_experiments/code/trainers/ex6_efficiency/benchmark_cnn_models_efficiency.py": [
        '["fold","params(M)","latency(ms/img)","fps"',
        'f"kfold_{args.model}_benchmark.csv"',
    ],
    "MSFUNet_experiments/code/trainers/ex6_efficiency/benchmark_vit_tiny_efficiency.py": [
        '["fold","params(M)","latency(ms)","fps","acc","precision","recall","f1","auc"]',
        '"kfold_vit_benchmark.csv"',
    ],
    "MSFUNet_experiments/code/trainers/ex6_efficiency/measure_resnet18_efficiency.py": [
